                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title">Add Ingredient Inventory Date</h4>
                           <ol class="breadcrumb p-0 m-0">
                              <li>
                                 <a href="#">Snowbee</a>
                              </li>
                              <li class="active">
                                 Add Ingredient Inventory Date
                              </li>
                           </ol>
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="card">
                           <div class="row">
                              <div class="col-md-6">
                                 <form class="form-horizontal" method="POST" action="../controller/add_ingredientInv_date.php">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-10">
                                          ...
                                          <a href="baker_add_ingredients_inventory.php" class="btn btn-danger waves-effect waves-light btn-md">
                                          Cancel
                                          </a>
                                       </div>
                                    </div>
