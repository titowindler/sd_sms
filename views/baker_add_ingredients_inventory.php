                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title">Add Ingredient Inventory</h4>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="demo-box m-t-20">
                           <div class="m-b-30">
                              <a href="baker_add_date_ingredients_inventory.php">
                                  ...
                                  <?php 
                                   ...
                                   ?> 
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          &nbsp;
                                          <a href="baker_display_ingredients_inventory.php?passID=<?php echo $ingredientInvId?>">VIEW</a>
                                       </td>
                                    </tr>
