                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title">Add Product Quantity</h4>
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="card">
                           <div class="row">
                              <div class="col-md-6">
                                 <form class="form-horizontal" method="POST" action="../controller/add_quantity.php">

                                    <input type="hidden" value="<?php echo $prodID?>" name="prodID">

                                    <div class="form-group">
                                       <label class="col-md-2 control-label">Add Product Quantity</label>
                                       <div class="col-md-10">
                                          <input type="text" class="form-control" placeholder="" name="add_quantity" required>
                                       </div>
                                    </div>
                                     <div class="form-group">
