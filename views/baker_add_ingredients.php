                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title">Add Ingredients</h4>
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="card">
                           <div class="row">
                              <div class="col-md-6">
                                 <form class="form-horizontal" method="POST" action="../controller/add_ingredient.php">
                                    <div class="form-group">
                                       <label class="col-md-2 control-label">Ingredients Name:</label>
                                       <div class="col-md-10">
                                          <input type="text" class="form-control" placeholder="" name="ingredient_name" required>
                                       </div>
                                    </div>
                                    <div class="form-group">
